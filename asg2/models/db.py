...
db.define_table('sellers',
   ...
   Field('phone'),
   Field('email'),
   Field('upvotes', 'integer', default=0, readable=False, writable=False),
   Field('downvotes', 'integer', default=0, readable=False, writable=False),
   Field('rating', 'integer', default=0, readable=False, writable=False))
